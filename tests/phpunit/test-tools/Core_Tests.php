...
class Core_Tests extends Base\TestCase {
	...
	public function test_setup() {
		// Setup
		\WP_Mock::expectActionAdded( 'init', 'Hero\Core\i18n' );
		\WP_Mock::expectActionAdded( 'init', 'Hero\Core\init' );
		\WP_Mock::expectAction( 'hero_loaded' );
	...
	public function test_i18n() {
		...
		\WP_Mock::onFilter( 'plugin_locale' )->with( 'en_US', 'hero' )->reply( 'en_US' );
		\WP_Mock::userFunction( 'load_textdomain', array(
			'times' => 1,
			'args' => array( 'hero', 'lang_dir/hero/hero-en_US.mo' ),
		) );
		...
		\WP_Mock::userFunction( 'load_plugin_textdomain', array(
			'times' => 1,
			'args' => array( 'hero', false, 'path/languages/' ),
		) );
	...
	public function test_init() {
		// Setup
		\WP_Mock::expectAction( 'hero_init' );
